...
Por medio de los sistemas fisicos interactivos es posible ampliar las posibilidades en todos los ámbitos posibles, en cuanto al entretenimiento digital es posible crear experiencias envolventes para los usuarios y por fuera es posible integrarlo en muchos campos por lo que es muy positivo tener la capacidad de hacerlo
